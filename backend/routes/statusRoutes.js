...
// ✅ Upload only images (without text)
router.post(
  "/upload-images",
  authMiddleware,
...
// ✅ Upload only video (without text)
router.post(
  "/upload-video",
  authMiddleware,
  upload.single("Video"),
...
// ✅ Get My Statuses
router.get("/my-statuses", authMiddleware, async (req, res) => {
  try {
...
router.post("/:id/comment", authMiddleware, async (req, res) => {
  try {
    ...
    status.Comments.push({ user: req.user._id, text: req.body.text });
    await status.save();
